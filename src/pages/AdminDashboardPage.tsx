...
import {
  ...
  Settings, LogOut, Key, Loader, IndianRupee
} from 'lucide-react';

type Tab = 'overview' | 'departments' | 'events' | 'coordinators' | 'registrations' | 'settings';
...
export function AdminDashboardPage() {
  ...
  const fetchStats = async () => {
    try {
      const [deptRes, evtRes, coordRes, regRes, deptsDataRes] = await Promise.all([
